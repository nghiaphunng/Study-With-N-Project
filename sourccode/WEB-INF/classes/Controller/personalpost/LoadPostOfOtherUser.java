...
@WebServlet("/LoadPostOfOtherUser")
public class LoadPostOfOtherUser extends HttpServlet {
	private static final long serialVersionUID = 1L;

    public LoadPostOfOtherUser() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    for(Post post : listPostOfInfoOtherUser) {
	    	...
	    	if(post.getTitle() != null && post.getTitle().trim().length() > 0) out.println("<div id=\"title-post-" + post.getTitle() + "\" class=\"title-post\">" + post.getTitle() + "</div>");
