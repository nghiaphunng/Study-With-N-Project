...
@WebServlet("/ClickFollowController")
public class ClickFollowController extends HttpServlet {
	private static final long serialVersionUID = 1L;

    public ClickFollowController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			//hiển thị bình luận
			FollowDAO.insertFollow(conn, user.getUserId(), userId);
