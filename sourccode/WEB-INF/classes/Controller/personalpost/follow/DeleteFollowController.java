...
@WebServlet("/DeleteFollowController")
public class DeleteFollowController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		FollowDAO.DeleteFollow(conn, visitingUserId, infoUserId);
		
		try {
			conn.close();
		} catch (SQLException e) {
			// TODO Auto-generated catch block
			ErrorDAO.insertError(conn, "Error closing Connection(DeleteFollowController)", e.getMessage());
		}
	}
