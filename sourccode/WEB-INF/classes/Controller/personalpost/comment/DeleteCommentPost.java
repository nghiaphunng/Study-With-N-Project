...
@WebServlet("/DeleteCommentPost")
public class DeleteCommentPost extends HttpServlet {
	private static final long serialVersionUID = 1L;

    public DeleteCommentPost() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			CommentDAO.deleteCommentPost(request, conn, commentId);
			...
			request.setAttribute("messageErrorDeleteCommentPost", e.getMessage());
		}
	}
