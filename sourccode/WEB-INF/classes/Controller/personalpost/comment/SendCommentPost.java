...
@WebServlet("/SendCommentPost")
public class SendCommentPost extends HttpServlet {
	private static final long serialVersionUID = 1L;

    public SendCommentPost() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			cmt1.setPostId(postId);
			cmt1.setFullNameUser(user.getFullName());
			CommentDAO.insertCommentPost(request, conn, cmt1, user.getUserId(), postId);
			...
			request.setAttribute("messageErrorSendCommentPost", e.getMessage());
		}
	}
