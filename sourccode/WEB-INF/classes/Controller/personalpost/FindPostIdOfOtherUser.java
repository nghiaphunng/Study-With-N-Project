...
@WebServlet("/FindPostIdOfOtherUser")
public class FindPostIdOfOtherUser extends HttpServlet {
	private static final long serialVersionUID = 1L;

    public FindPostIdOfOtherUser() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int limit = PostDAO.FindPostPositionOtherUser(request, conn, user.getUserId(), infoUserId, postId);
		...
		RequestDispatcher rd = request.getRequestDispatcher("UserInforPageForward?userid=" + infoUserId);
		rd.forward(request, response);
	}
